...
- **Built for agents and humans together.** 17 MCP tools for issues, comments and docs. What an agent does shows up in your UI right away over WebSocket.
...
`list_workspaces`, `create_workspace`, `update_workspace`, `list_projects`, `create_project`, `update_project`, `list_issues`, `get_issue`, `create_issue`, `update_issue`, `comment_issue`, `list_documents`, `get_document`, `create_document`, `update_document`, `comment_document`, `delete_document`.
